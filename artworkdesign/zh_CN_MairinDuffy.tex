\chapterwithauthor{Máirín Duffy Strode}{不要含羞}

\authorbio{Máirín Duffy Strode 一直使用免费的开源软件在她高中的时候, 并且在过去的8年里成为了他的贡献者. 
她参与了Fedora和GNOME社区并且参与合作、品牌的互动设计, 并且或则摄影了一些开源软件的申请，像
Spacewalk, Anaconda, virt-manager, SELinux 和 SSSD. 她也努力参与教育孩子们使用开源软件设计的技巧，像
GIMP和Inkscape 这种说是工具有点凶猛的软件. 她是
Fedora设计队伍的领导并且是Red Hat的高级交互工程设计师 Inc.}
